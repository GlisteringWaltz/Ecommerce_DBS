...
if(isset($_GET['form1'])) {
    ...
    if( empty($_GET['cust_new_password']) || empty($_GET['cust_re_password']) )
    {
        $valid = 0;
    ...
    {
        if($_GET['cust_new_password'] != $_GET['cust_re_password'])
        {
            $valid = 0;
    ...
    if($valid == 1) {
        ...
        $cust_new_password = strip_tags($_GET['cust_new_password']);
